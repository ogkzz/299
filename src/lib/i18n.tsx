...
const translations: Record<Locale, Record<string, string>> = {
  'pt-BR': {
    ...
    'blacklist.confirm_remove': 'Confirmar Remoção',
    'blacklist.password_required': 'A remoção da blacklist requer autenticação por senha. Todas as tentativas são registradas.',
    'blacklist.password_placeholder': 'Digite a senha de administrador',
    'blacklist.wrong_password': 'Senha incorreta. Tentativa registrada no log de auditoria.',
    'blacklist.cancel': 'Cancelar',
    'blacklist.confirm': 'Remover',
    'blacklist.remove_protected': 'Remover (protegido)',
  ...
  'en': {
    ...
    'blacklist.confirm_remove': 'Confirm Removal',
    'blacklist.password_required': 'Removing from blacklist requires admin password authentication. All attempts are logged.',
    'blacklist.password_placeholder': 'Enter admin password',
    'blacklist.wrong_password': 'Incorrect password. Attempt logged in audit trail.',
    'blacklist.cancel': 'Cancel',
    'blacklist.confirm': 'Remove',
    'blacklist.remove_protected': 'Remove (protected)',
  ...
  'es': {
    ...
    'blacklist.export': 'Exportar',
    'blacklist.confirm_remove': 'Confirmar Eliminación',
    'blacklist.password_required': 'Eliminar de la blacklist requiere contraseña de administrador. Todos los intentos quedan registrados.',
    'blacklist.password_placeholder': 'Ingrese la contraseña de admin',
    'blacklist.wrong_password': 'Contraseña incorrecta. Intento registrado en el log de auditoría.',
    'blacklist.cancel': 'Cancelar',
    'blacklist.confirm': 'Eliminar',
    'blacklist.remove_protected': 'Eliminar (protegido)',
